...
// int main() {
//     std::cout << "==========================================\n";
//     std::cout << "       Testing Diagram  \n";
//     std::cout << "==========================================\n\n";

//     // creating  the Diagram
//     std::cout << "Creating an empty Diagram...\n";
//     Diagram myDiagram;
//     std::cout << "Shape count: " << myDiagram.getObjectCount() << "\n\n";

//     // adding shapes  to the Diagram
//     std::cout << "Adding shapes to Diagram...\n";

//     // adding  a Circle
//     auto c = std::make_unique<Circle>(100, 100, 50);
//     c->setFillColor("red");
//     myDiagram.addObject(std::move(c));

//     // adding  a Rectangle
//     auto r = std::make_unique<Rectangle>(200, 200, 100, 50);
//     r->setStrokeColor("blue");
//     myDiagram.addObject(std::move(r));

//     // adding a Hexagon
//     auto h = std::make_unique<Hexagon>(300, 100, 40);
//     h->setStrokeColor("green");
//     myDiagram.addObject(std::move(h));

//     // adding  Text
//     auto t = std::make_unique<Text>(50, 50, "Diagram Test");
//     t->setFrontSize(20);
//     myDiagram.addObject(std::move(t));

//     std::cout << "Diagram now contains " << myDiagram.getObjectCount() << " shapes.\n\n";

//     // 3. Iterate through the Diagram and print SVG
//     std::cout << "Reading shapes from Diagram...\n";
//     const auto& shapes = myDiagram.getShapes();
    
//     for (const auto& shape : shapes) {
//         std::cout << "Found shape:" << shape->getType() << "\n";
//         std::cout << "SVG: " << shape->toSVG() << "\n";
//     }
//     std::cout << "\n";

//     // 4. Generate SVG File from Diagram
//     std::cout << "Saving Diagram to 'diagram_output.svg'...\n";
//     std::ofstream file("diagram_output.svg");
//     file << "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";
...
//     // 5. Clear Diagram
//     std::cout << "Clearing Diagram...\n";
//     myDiagram.clearallObjects();
//     std::cout << "Shape count after clear: " << myDiagram.getObjectCount() << "\n";

//     std::cout << "==========================================\n";
//     std::cout << "       Diagram Test Complete!\n";
//     std::cout << "==========================================\n";
